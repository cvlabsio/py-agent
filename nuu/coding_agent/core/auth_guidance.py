...
GUIDANCE: dict[str, str] = {
    ...
    "ollama": "Runs locally by default at http://localhost:11434/v1. API key is optional; set OLLAMA_API_KEY only if your proxy requires auth.",
    "vllm": "Runs locally by default at http://localhost:8000/v1. API key is optional; set VLLM_API_KEY only if your server requires auth.",
    "openai-compatible": "Use an OpenAI-compatible endpoint (default http://localhost:4000/v1). API key is optional; set OPENAI_COMPATIBLE_API_KEY if required.",
    "lm-studio": "Runs locally by default at http://localhost:1234/v1. API key is optional; set LM_STUDIO_API_KEY only if your proxy requires auth.",
    "localai": "Runs locally by default at http://localhost:8080/v1. API key is optional; set LOCALAI_API_KEY if your deployment enforces auth.",
