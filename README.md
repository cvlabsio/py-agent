...
| `OLLAMA_API_KEY` | Ollama (optional for localhost) |
| `VLLM_API_KEY` | vLLM (optional for localhost) |
| `OPENAI_COMPATIBLE_API_KEY` | OpenAI-Compatible endpoint (optional) |
| `LM_STUDIO_API_KEY` | LM Studio (optional for localhost) |
| `LOCALAI_API_KEY` | LocalAI (optional for localhost) |

Local defaults for OpenAI-compatible providers:
